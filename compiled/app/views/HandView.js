    ...
    HandView.prototype.initialize = function() {
      ...
      this.collection.on('lose', function() {
        if (_this.collection.isDealer) {
          return _this.trigger('playerWin', _this);
        } else {
          return _this.trigger('dealerWin', _this);
        }
      });
      this.collection.on('resetNew', function() {
        return _this.collection.map(function(card) {
          return card.set('newCard', false);
        });
      });
      return this.render();
    };
